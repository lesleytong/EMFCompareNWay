...
/**
 * This is the item provider adapter for a {@link compare.Conflict} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_kind_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_kind_feature", "_UI_Conflict_type"),
				 ComparePackage.Literals.CONFLICT__KIND,
				 true,
				 false,
				 false,
	...
	protected void addDifferencesPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Conflict_differences_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Conflict_differences_feature", "_UI_Conflict_type"),
				 ComparePackage.Literals.CONFLICT__DIFFERENCES,
				 true,
				 false,
				 true,
				 null,
