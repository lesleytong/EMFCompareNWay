...
/**
 * This is the item provider adapter for a {@link compare.ReferenceChange} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ReferenceChangeItemProvider extends DiffItemProvider {
	/**
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 ComparePackage.Literals.REFERENCE_CHANGE__REFERENCE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void addValuePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_ReferenceChange_value_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_ReferenceChange_value_feature", "_UI_ReferenceChange_type"),
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ?
			getString("_UI_ReferenceChange_type") :
			getString("_UI_ReferenceChange_type") + " " + label;
	}
