...
public class ChangeEngine {
	...
	public static void getM0(Resource baseResource, URI m0URI, Boolean flag) {
		if (flag == true) {
...
//	public static void testMerge(String NsURIName, EPackage ep, TypeGraph typeGraph, List<URI> uriList,
//			List<TypeEdge> typeEdgeList, List<PropertyEdge> propertyEdgeList, URI metaModelURI, URI m1URI) {
//
...
//		System.out.println("差分与合并所花时间：" + (end - endMatch) + " ms.");
