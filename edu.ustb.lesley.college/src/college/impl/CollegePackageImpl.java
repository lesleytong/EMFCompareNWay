 ...
 * @generated
 */
public class CollegePackageImpl extends EPackageImpl implements CollegePackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see college.CollegePackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private CollegePackageImpl() {
		super(eNS_URI, CollegeFactory.eINSTANCE);
	}
	 ...
	 *
	 * <p>This method is used to initialize {@link CollegePackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static CollegePackage init() {
		if (isInited) return (CollegePackage)EPackage.Registry.INSTANCE.getEPackage(CollegePackage.eNS_URI);

		// Obtain or create and register package
		Object registeredCollegePackage = EPackage.Registry.INSTANCE.get(eNS_URI);
		CollegePackageImpl theCollegePackage = registeredCollegePackage instanceof CollegePackageImpl ? (CollegePackageImpl)registeredCollegePackage : new CollegePackageImpl();

		isInited = true;

		// Create package meta-data objects
		theCollegePackage.createPackageContents();

		// Initialize created meta-data
		theCollegePackage.initializePackageContents();

		// Mark meta-data to indicate it can't be changed
		theCollegePackage.freeze();

		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(CollegePackage.eNS_URI, theCollegePackage);
		return theCollegePackage;
	}
	 ...
	 */
	@Override
	public EReference getPerson_Colleges() {
	 ...
	 */
	@Override
	public CollegeFactory getCollegeFactory() {
		return (CollegeFactory)getEFactoryInstance();
	}
